...
class MigrationDefinitionWriterDataTypeTest extends TestCase
{
    ...
    public static function columnTypeProvider(): array
    {
        return [
            ...
            'decimal no params' => ['`sample` DECIMAL NOT NULL', ["\$table->decimal('sample');"]],
            'decimal precision only' => ['`sample` DECIMAL(10) NOT NULL', ["\$table->decimal('sample', 10);"]],
            'decimal' => ['`sample` DECIMAL(8,2) NOT NULL', ["\$table->decimal('sample', 8, 2);"]],
